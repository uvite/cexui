...
export const privacyAtom = focusAtom(appSettingsAtom, (o) => o.prop('global').prop('privacy'));
...
export const soundAtom = focusAtom(appSettingsAtom, (o) => o.prop('global').prop('sound'));

export const utcAtom = focusAtom(appSettingsAtom, (o) => o.prop('global').prop('utc'));
...
export const toggleSoundAtom = atom(null, (get, set) => set(soundAtom, !get(soundAtom)));
...
export const setMessageHistoryAtom = atom(null, (get, set, news: NewsWithSymbols[]) => {
